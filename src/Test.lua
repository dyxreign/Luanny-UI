...
function LuannyUi:CreateWindow(config) 
    ...
    WindowConfig.ThemeData = Themes[WindowConfig.Theme] or Themes.Dark
...
function TabClass:Section(options) 
    ...
    return { 
        SetTitle = function(self, t) lbl.Text = type(self) == "table" and t or self end, 
        Destroy = function() sectionFrame:Destroy() end 
    } 
end 

function TabClass:Label(options) 
    self.ItemCount = self.ItemCount + 1 
    local theme = WindowConfig.ThemeData
    ...
    elseif typeof(options) == "table" then
        textContent = options.Content or options.Title or options.Text or "Label"
        if options.Color then textColor = options.Color end
    end
    
    local card = Instance.new("Frame", self.Container) 
    card.Size = UDim2.new(0, 340, 0, 35) 
    ...
    local lblTitle = Instance.new("TextLabel", card) 
    lblTitle.Size = UDim2.new(1, -20, 1, 0)
    lblTitle.Position = UDim2.new(0, 10, 0, 0)
    lblTitle.BackgroundTransparency = 1
    lblTitle.Text = textContent
    lblTitle.TextColor3 = textColor
    lblTitle.FontFace = FontUI
    lblTitle.TextSize = 13
    ...
    return { 
        Set = function(self, newText, newColor) 
            ...
            if newText then lblTitle.Text = tostring(newText) end
            if newColor then lblTitle.TextColor3 = newColor end
        end, 
...
function TabClass:Button(options) 
    ...
    return { 
        SetTitle = function(self, t) lblTitle.Text = type(self) == "table" and t or self end, 
        SetDesc = function(self, d) lblDesc.Text = type(self) == "table" and d or self end, 
        Lock = function() 
...
function TabClass:Toggle(options) 
    ...
    return { 
        SetTitle = function(self, t) lblTitle.Text = type(self) == "table" and t or self end, 
        SetDesc = function(self, d) lblDesc.Text = type(self) == "table" and d or self end, 
        SetValue = function(self, v) state = type(self) == "table" and v or self; updateVisual() end, 
        Lock = function() 
            lockOverlay.Visible = true
            TweenService:Create(lockOverlay, TweenInfo.new(0.2), {BackgroundTransparency = 0.5}):Play() 
        end, 
...
function TabClass:Input(options) 
    ...
    return { 
        SetTitle = function(self, t) lblTitle.Text = type(self) == "table" and t or self end, 
        SetDesc = function(self, d) lblDesc.Text = type(self) == "table" and d or self end, 
        SetPlaceholder = function(self, p) box.PlaceholderText = type(self) == "table" and p or self end, 
        SetValue = function(self, v) box.Text = type(self) == "table" and v or self end, 
        Lock = function() 
            lockOverlay.Visible = true
            TweenService:Create(lockOverlay, TweenInfo.new(0.2), {BackgroundTransparency = 0.5}):Play() 
        end, 
...
function TabClass:Dropdown(options) 
    ...
    return { 
        SetTitle = function(self, t) lblTitle.Text = type(self) == "table" and t or self end, 
        Destroy = function() card:Destroy() end, 
        Set = function(self, v) currentValue = type(self) == "table" and v or self; selectBtn.Text = " " .. currentValue end, 
...
function TabClass:Slider(options) 
    ...
    return { 
        SetTitle = function(self, t) lblTitle.Text = type(self) == "table" and t or self end, 
        SetDesc = function(self, d) lblDesc.Text = type(self) == "table" and d or self end, 
        SetMin = function(self, min) minVal = type(self) == "table" and min or self; updateValue(currentVal, true) end, 
        SetMax = function(self, max) maxVal = type(self) == "table" and max or self; updateValue(currentVal, true) end, 
        SetValue = function(self, v) updateValue(type(self) == "table" and v or self, true) end, 
        Lock = function() 
            lockOverlay.Visible = true
            TweenService:Create(lockOverlay, TweenInfo.new(0.2), {BackgroundTransparency = 0.5}):Play() 
        end, 
...
function TabClass:ColorPicker(options)
    ...
    return {
        ...
        Destroy = function() card:Destroy() end,
        Set = function(self, v) 
            currentColor = type(self) == "table" and v or self
            H, S, V = currentColor:ToHSV()
            updateVisuals() 
        end,
